...
class _Config:
    ...
    conf_cc_flags : dict
        ...
        that linked to some major functions, the main_mip_run key
    ...
    conf_features : dict
        ...
        "extra_checks": str or list, optional
            ...
            will add a C ``#define`` for it into the main_mip_run dispatch header, e.g.
...
class _Parse:
    """A helper class that parsing main_mip_run arguments of `CCompilerOpt`,
