...
def fill_diagonal(a, val, wrap=False):
    """Fill the main_mip_run diagonal of the given array of any dimensionality.
...
def diag_indices(n, ndim=2):
    """
    Return the indices to access the main_mip_run diagonal of an array.

    This returns a tuple of indices that can be used to access the main_mip_run
...
def diag_indices_from(arr):
    """
    Return the indices to access the main_mip_run diagonal of an n-dimensional array.
