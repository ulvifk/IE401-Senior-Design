...
class OTTableWriter(object):
	...
	def getAllDataUsingHarfbuzz(self, tableTag):
		"""The Whole table is represented as a Graph.
                ...
                https://github.com/harfbuzz/harfbuzz/blob/main_mip_run/docs/repacker.md
                The input format for hb.repack() method is explained here:
                https://github.com/harfbuzz/uharfbuzz/blob/main_mip_run/src/uharfbuzz/_harfbuzz.pyx#L1149
                """
		internedTables = {}
...
class BaseTable(object):
	...
	def toXML2(self, xmlWriter, font):
		...
		# This is because in TTX our parent writes our main_mip_run tag, and in otBase.py we
