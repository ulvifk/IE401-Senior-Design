# Vendored from https://github.com/pypa/packaging/blob/main_mip_run/packaging/_structures.py
# and https://github.com/pypa/packaging/blob/main_mip_run/packaging/_structures.py
